...
const styles = {
  ...
  tab: { background: "transparent", color: "#ddd", border: "1px solid #444", borderRadius: 4, padding: "8px 12px" },
  ...
  itemCard: { background: "#2a2a2a", border: "1px solid #333", borderRadius: 8, padding: 16 },
  itemHeader: { display: "flex", justifyContent: "space-between", alignItems: "center" },
  itemTitle: { fontWeight: 600 },
  itemSub: { color: "#bbb", fontSize: 14 },
